...
public final class ConnectivityFragment extends Hilt_ConnectivityFragment {
  ...
  private final ConnectionManager.ConnectionCallback connectionCallback =
      new ConnectionManager.ConnectionCallback() {
        ...
        @Override
        public void onBandwidthChanged(String remoteDeviceName, BandwidthInfo bandwidthInfo) {
          String quality = bandwidthQualityToString(bandwidthInfo.getQuality());
          status.setText(getContext().getString(R.string.connected, remoteDeviceName, quality));
        }
  ...
  public void onViewCreated(View view, Bundle bundle) {
    ...
    ConnectionManager.ConnectionStatus connectionStatus = connectionManager.getConnectionStatus();
